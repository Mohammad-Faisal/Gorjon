...
public class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.ViewHolder>{
    ...
    public PostsAdapter(List<Posts> data , Context context , Activity activity ){
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.postCommentLinear.setOnClickListener(v -> {
            ...
            final CommentsAdapter mCommentsAdapter = new CommentsAdapter(commentList, context , activity);
