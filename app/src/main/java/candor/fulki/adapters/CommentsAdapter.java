...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.PostCommentViewHolder> {
    ...
    // ---- CONSTRUCTOR --//
    public CommentsAdapter(List<Comments> mCommentList , Context context , Activity activity){
    ...
    @NonNull
    @Override
    public CommentsAdapter.PostCommentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_comment, parent , false);
        return new CommentsAdapter.PostCommentViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final CommentsAdapter.PostCommentViewHolder holder, int position) {
