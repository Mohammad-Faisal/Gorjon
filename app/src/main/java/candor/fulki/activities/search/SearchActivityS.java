...
import candor.fulki.adapters.HorizontalRecyclerAdapterforsearch;
import candor.fulki.adapters.VerticalRecyclerAdapterforsearch;
import candor.fulki.models.UserSearch;


public class SearchActivityS extends AppCompatActivity
        implements HorizontalRecyclerAdapterforsearch.OnButtonClickListener1
{
    ...
    private Context mContext = SearchActivityS.this;
    ...
    private DIistrictsAdapter DIistrictsAdapter;
    ...
    private void initData() {
        ...
        mSearchEdt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DIistrictsAdapter =new DIistrictsAdapter(mStringList,mContext);
                ...
                lv.setAdapter(DIistrictsAdapter);
                alertDialog.show();
                editText.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        DIistrictsAdapter.getFilter().filter(s);
