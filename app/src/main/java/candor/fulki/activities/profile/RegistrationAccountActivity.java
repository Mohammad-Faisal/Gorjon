...
public class RegistrationAccountActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
   ...
   private byte[] thumb_byte;
    ...
    private void uploadImageThenDetails(){
        mProgress = new ProgressDialog(RegistrationAccountActivity.this);
    ...
    private boolean validateData(){
        if(main_bytes == null){
            Timber.tag("Fulki").d("main byte is null");
            Toast.makeText(RegistrationAccountActivity.this, "please select your image", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(thumb_byte == null){
            Timber.tag("Fulki").d("thumb byte is null");
            Toast.makeText(RegistrationAccountActivity.this, "please select your image", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(name.equals("")){
            Toast.makeText(RegistrationAccountActivity.this, "please give us your name", Toast.LENGTH_SHORT).show();
            return false;
        }else if(mGender==2){
            Toast.makeText(RegistrationAccountActivity.this, "Please Select your gender", Toast.LENGTH_SHORT).show();
        }
        return true;
    }
    ...
    private void uploadUserDetails(){
        ...
        writeBatch.commit().addOnSuccessListener(aVoid -> {
            Intent homeIntent = new Intent(RegistrationAccountActivity.this, MainActivity.class);
    ...
    public void initViews(){
        mProgressDialog = new ProgressDialog(RegistrationAccountActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_log_out:
                Functions.logOut();
                Intent mainIntent = new Intent(RegistrationAccountActivity.this, MainActivity.class);
    ...
    private void loadCategories(){
        ...
        mCategoriesAdapter = new CategoriesAdapter(categoriesList,RegistrationAccountActivity.this, RegistrationAccountActivity.this);
        mRegCategoryRecycler.setLayoutManager(new LinearLayoutManager(RegistrationAccountActivity.this));
